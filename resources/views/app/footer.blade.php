    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                ...
                <p class="text-gray-300 mb-4">Website resmi Pemerintah Desa Winangun Atas, Kecamatan Pineleng, Kabupaten Minahasa.</p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-300">Jl. Raya Manado Tomohon, Winangun Atas, Kec. Pineleng</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="h-5 w-5 text-[#3ab5b0] mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="text-gray-300">0811431539</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="h-5 w-5 text-[#3ab5b0] mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
